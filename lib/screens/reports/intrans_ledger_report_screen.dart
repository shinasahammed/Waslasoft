...
class IntransLedgerReportScreen extends StatefulWidget {
  const IntransLedgerReportScreen({super.key});

  @override
  State<IntransLedgerReportScreen> createState() =>
      _IntransLedgerReportScreenState();
}

class _IntransLedgerReportScreenState extends State<IntransLedgerReportScreen> {
  ...
  final List<Map<String, dynamic>> _ledgerItems = [
    {
      "sno": "1",
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _tableCell(width: 50, content: Text("Sno.", style: _headerStyle())),
          _tableCell(
            width: 180,
            content: Text("Description", style: _headerStyle()),
          ),
          _tableCell(
            width: 70,
            content: Text(
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _tableCell(
            width: 70,
            content: Text(qty, style: _rowStyle(), textAlign: TextAlign.center),
          ),
          _tableCell(
            width: 90,
            content: Text(rate, style: _rowStyle(), textAlign: TextAlign.right),
          ),
          _tableCell(
            width: 100,
            content: Text(
          ...
          _tableCell(
            ...
            content: Text(
              credit,
              style: _rowStyle(color: Colors.red[600]!),
              textAlign: TextAlign.right,
            ),
          ),
          _tableCell(
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              _buildSummaryItem("Net Qty", "23.00"),
              _buildSummaryItem("Net Total", "0.00"),
              _buildSummaryItem("Net Credit", "1,250.00"),
            ],
          ),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xFFFFB74D), // Green from image
