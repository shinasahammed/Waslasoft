...
class MarketSurveyReportScreen extends StatefulWidget {
  const MarketSurveyReportScreen({super.key});

  @override
  State<MarketSurveyReportScreen> createState() =>
      _MarketSurveyReportScreenState();
}

class _MarketSurveyReportScreenState extends State<MarketSurveyReportScreen> {
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _tableCell(width: 150, content: Text("Id", style: _headerStyle())),
