...
class ReceiptReportScreen extends StatefulWidget {
  const ReceiptReportScreen({super.key});

  @override
  State<ReceiptReportScreen> createState() => _ReceiptReportScreenState();
}

class _ReceiptReportScreenState extends State<ReceiptReportScreen> {
