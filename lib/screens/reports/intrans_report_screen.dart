...
class IntransReportScreen extends StatefulWidget {
  const IntransReportScreen({super.key});

  @override
  State<IntransReportScreen> createState() => _IntransReportScreenState();
}

class _IntransReportScreenState extends State<IntransReportScreen> {
