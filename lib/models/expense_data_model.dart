...
List<Expensedatamodel> expensedatamodelFromJson(String str) => List<Expensedatamodel>.from(json.decode(str).map((x) => Expensedatamodel.fromJson(x)));

String expensedatamodelToJson(List<Expensedatamodel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
